...
class bonus_admin_purview_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        $purviews = array(
        	array('action_name' => RC_Lang::get('bonus::bonus.bonus_type_manage'), 	'action_code' => 'bonus_manage',		'relevance' => ''),
        	array('action_name' => RC_Lang::get('bonus::bonus.bonus_type_add'), 	'action_code' => 'bonus_type_add', 		'relevance' => ''),
