...
function user_bonus($user_id, $goods_amount = 0, $cart_id = array(), $store_id = 0) {
	...
	$dbview = RC_DB::table('user_bonus as ub')
		...
		$row = $dbview->select(RC_DB::raw('ut.bonus_sn, bt.type_id, bt.store_id, bt.type_name, bt.type_money, ub.bonus_id, bt.usebonus_type,bt.min_goods_amount,bt.use_start_date,bt.use_end_date'))
